...
const DeliveryPaymentPage: React.FC = () => {
  ...
  return (
    <main className="md:pt-[20px] lg:pt-[200px] xl:pt-[100px] flex justify-center min-h-screen  text-white">
      <div className="container mx-auto px-6 py-24">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-0 md:gap-8">
          <div className="mb-8 md:mb-0 md:mx-16">
            ...
            >
              Доставка <span className='text-soft-sand/70 md:text-soft-sand'>та оплата</span>
            </AnimatedElement>
                ...
                >
                  {section.content.map((content, idx) => {
                    if (content.type === 'delivery') {
                      ...
                      return <p key={idx} className="font-semibold text-left text-md md:text-md md:text-xl lg:text-2xl xl:text-xl xxl:text-2xl mb-4 p-4 rounded-xl bg-soft-sand/50">{content.text}</p>;
                    }
                  })}
                </Section>
              </AnimatedElement>
