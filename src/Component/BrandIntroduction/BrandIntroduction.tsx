  ...
  return (
    <div className="mx-auto py-16 pt-24 bg-light-gray-green">
      <h2 className="text-2xl sm:text-3xl  md:text-6xl font-forum text-center mb-4 xl:mb-8 text-white px-4">
        ...
        <div className="relative flex justify-center items-center py-6 md:py-12">
          ...
          <div className="z-20 text-6xl md:text-8xl lg:text-[140px]">TAKOSTA</div>
        </div>
      </h2>
      <div className="mx-auto lg:py-10 px-4 md:px-4 lg:px-6 xl:px-12 text-sm md:text-xl lg:text-3xl xl:text-4xl leading-relaxed text-center text-white font-sans">
