...
const BrandIntroduction = () => {
  return (
    <div className="mx-auto px-4 py-16 pt-24 bg-light-gray-green">
      <h2 className="text-4xl lg:text-[85px] font-forum text-center mb-8 text-white">
        <span className="font-pushkin text-6xl lg:text-[140px] text-soft-sand mr-4">
          Привіт ,
        </span>
        це бренд
        <div className="relative flex justify-center items-center my-12">
          <svg className="oval absolute -sacle-110  xl:scale-150  lg:w-[400px] lg:h-[200px]">
            <path
      ...
      <div className="mx-auto py-10 px-4 lg:px-12 max-w-[80%] text-lg lg:text-4xl leading-relaxed text-center text-white font-sans">
